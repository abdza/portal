...
import org.portalengine.portal.repositories.DataUpdateRepository;
...
public class DataUpdateService {
	...
	public void deleteUpdate(DataUpdate dataupdate) {
		...
		String delquery = "delete from " + dataupdate.getTracker().getDataTable() + " where " + dbEscapeColumn("dataupdate_id") + "=:id";
